/*codehim's javascript*/ /*https://www.codehim.com/demo/javascript-shopping-cart-source-code/*/
"use strict";                        
let cart = [];
let cartTotal = 0;
...
if (IsinCart === false) {
  ...
  <div class="d-flex flex-row shadow-sm card cart-items mt-2 mb-3 animated flipInX">
    ...
    <div class="p-2 mt-3 ml-auto">
        <button hidden class="btn badge badge-secondary" type="button" data-action="increase-item">&plus;
    </div>
    <div class="p-2 mt-3">
      <p class="text-success cart_item_quantity">${product.quantity}</p>
    </div>
    <div class="p-2 mt-3">
      <button hidden class="btn badge badge-info" type="button" data-action="decrease-item">&minus;
    </div>
    <div class="p-2 mt-3">
    ...
    cartDom.insertAdjacentHTML("afterend",  `
      <div class="d-flex flex-row shadow-sm card cart-footer mt-2 mb-3 animated flipInX">
        ...
        <div class="p-2 ml-auto">
          <button class="btn badge-dark" type="button" data-action="check-out">Pay <span hidden class="pay"></span> 
            &#10137;
        </div>
      </div>`); }
...
function checkOut() {
  ...
  <form id="paypal-form" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
    ...
    <input type="hidden" name="business" value="musicbox@gmail.com">
